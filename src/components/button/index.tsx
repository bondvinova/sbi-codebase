...
export const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-sm focus-visible:outline-none focus-visible:ring-2 disabled:pointer-events-none active:scale-[0.98] transition-all outline-none tracking-normal',
  {
    variants: {
      variant: {
        default:
